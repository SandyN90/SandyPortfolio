<template>
    <footer class="bg-gray-100">
        <div class="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8 divide-y divide-gray-500 space-y-20">
...
import { PhoneIcon, MapIcon, PaperAirplaneIcon } from '@heroicons/vue/solid';


const navigation = {
    "main": [
        { name: 'G357, Gamma 2 Greater Noida, Uttar Pradesh', href: '#', icon: MapIcon },
        { name: '+918318485141', href: '#', icon: PhoneIcon },
        { name: 'sandeepkumarnavik5@gmail.com', href: '#', icon: PaperAirplaneIcon },
    ],
    social: [
        {
            name: 'Facebook',
