...
<template>
    <Disclosure as="nav" class="bg-gray-800 fixed z-10 w-full" v-slot="{ open }">
          ...
          <div class="flex items-center">
            ...
            <div class="hidden sm:block sm:ml-6">
              <div class="flex space-x-4">
                ...
                <router-link to="/aboutus" href="#" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">About Me</router-link>
                <router-link to="/contact" href="#" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Projects</router-link>
  ...
  import { BellIcon, MenuIcon, XIcon } from '../plugginWrapper/heroiconsSolid';
  </script>